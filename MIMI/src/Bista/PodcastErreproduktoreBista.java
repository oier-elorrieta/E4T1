...
public class PodcastErreproduktoreBista extends JFrame implements Inabegazioa {
	...
	public PodcastErreproduktoreBista(Bezero bz, int selectedValue, List<Podcast> podcastList, Podcaster podcaster)
			throws SQLException {
		setResizable(false);
