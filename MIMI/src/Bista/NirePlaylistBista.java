	...
	public NirePlaylistBista(Bezero bz) {
		...
		btnSortu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					NirePlaylistDao.sortuPlaylist(bz, playListIzenBerri);
		...
		btnImportatu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Implement the functionality for importing a playlist
		...
		btnExportatu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Implement the functionality for exporting a playlist
		...
		btnSartu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
//				Playlist playlist = listak.get(listPlaylist.getSelectedIndex());
