...
public class BezeroTest {
    ...
    public void testGetAbizenaTrue() {
        Bezero bezero = new Bezero("BZ009", "mimi", "talde", "mimitalde", "password", "2024-04-19", "2024-04-20", new ArrayList<>(), null);
        assertEquals("talde", bezero.getAbizena());
    }
    
    @Test
    public void testGetAbizenaFalse() {
        Bezero bezero = new Bezero("BZ009", "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), Date.valueOf("2024-04-20"), new ArrayList<>(), null);
        assertNotEquals("Garcia", bezero.getAbizena());
    }

    @Test
    public void testSetAbizenaTrue() {
        Bezero bezero = new Bezero(0, null, null, null, null, null, null, null, null);
    ...
    public void testGetErabiltzaileTrue() {
        Bezero bezero = new Bezero(1, "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), Date.valueOf("2024-04-20"), new ArrayList<>(), null);
    ...
    public void testGetJaioDataTrue() {
        ...
        Bezero bezero = new Bezero(1, "mimi", "talde", "mimitalde", "password", jaioData, Date.valueOf("2024-04-20"), new ArrayList<>(), null);
    ...
    public void testGetErregisData() {
        ...
        Bezero bezero = new Bezero(1, "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), erregisData, new ArrayList<>(), null);
    ...
    public void testGetPlayArray() {
        ...
        Bezero bezero = new Bezero(1, "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), Date.valueOf("2024-04-20"), playArray, null);
    ...
    public void testEquals() {
        Bezero bezero1 = new Bezero(1, "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), Date.valueOf("2024-04-20"), new ArrayList<>(), null);
        Bezero bezero2 = new Bezero(1, "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), Date.valueOf("2024-04-20"), new ArrayList<>(), null);
    ...
    public void testEqualsFalse() {
        Bezero bezero1 = new Bezero(1, "mimi", "talde", "mimitalde", "password", Date.valueOf("2024-04-19"), Date.valueOf("2024-04-20"), new ArrayList<>(), null);
        Bezero bezero2 = new Bezero(2, "Mirari", "Casillas", "micasillas", "ninguna", Date.valueOf("1990-01-01"), Date.valueOf("2022-04-19"), new ArrayList<>(), null);
    ...
    public void testToString() {
        ArrayList<Abesti> playArray = new ArrayList<>();
        playArray.add(new Abesti(1, "Song1", 3.5, "Album1", "Artist1"));
        Bezero bezero = new Bezero(1, "John", "Doe", "johndoe", "password", Date.valueOf("2000-01-01"), Date.valueOf("2022-04-18"), playArray, null);
        String expectedToString = "Bezero [id=1, izena=John, abizena=Doe, erabiltzaile=johndoe, pasahitza=password, jaioData=2000-01-01, erregisData=2022-04-18, mota=null, playArray=" + playArray + "]";
