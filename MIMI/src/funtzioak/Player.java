...
public class Player implements Iplayer {
	...
	private Clip klipa;
	public static boolean iragarkia;

	public Player() {
	}

	/**
	 * Player klasea abestien erreproduziorako erabiltzen da. Abestiak, bezeroa eta
	 * indexa jasotzen ditu konstruktorea.
	 */
	 ...
	 * 
	 * Indizea 0 baino txikiagoa bada, playlistaren azkenengo abestia
	 * erreproduzitzen da.
	 * 
	...
	/**
	 * Indizea size baino handiagoa bada, indizea 0-ra berreskuratzen du. Gero,
	 * musika gelditzen da eta berriro erreproduzitzen da. AteraArgazkia eta
	 * ateraInformazioa metodoak deitzen dira. Argazkia eta informazioa pantailan
	 * erakusten dira.
	 * 
	...
	/**
	 * Pausatu metodoa abestia erreproduktzen ari bada. Abestia erreproduktzen ari
	 * bada, abestia gelditu egiten da. Abestirik ez badago erreproduktzen, "Ez dago
	 * abestirik erreproduzitzen." mezua inprimatzen da.
	 */
	public void pause() {
	 ...
	 * 
	 * Irudia ateratzeko, abestiaren ID lortu eta abestiaren izena irudiaren
	 * izenarekin konparatzen da.
	 * 
	 * @param lblIrudi JLabel-a, non irudia kokatuko den.
	 * @param indizea  Abestiaren indizea, aukeratutako abestia aurkitzeko erabiliko
	 *                 den.
	...
	/**
	 * KenduWav metodoa erabiltzen da emandako fitxategiaren izenaren luzapena kendu
	 * eta itzultzen du.
	 *
	...
	/**
	 * Metodo honek murrizketa hasieratzen du, botoiak desgaitzeko eta gero berriro
	 * gaitzeko.
	 * 
	 * TimerTask klasea erabiliz, botoiak desgaitzen dira eta 10 minutu gero berriz
	 * gaitzen dira.
	 * 
	 * Funztio honek bakarrik hasi egingo da, abestiak erreproduzitzen hasi baino
	 * lehen eta bezeroa Free planan dagoenean.
	 * 
	...
	public void murrizketaHasieratu(JButton btnAbestiAurrera, JButton btnAbestiAtzera, Bezero bz, List<Abesti> abestiak,
		...
		try {
			IragarkiBista frame = new IragarkiBista(bz, abestiak, album, artistaIzena, albumak, btnAbestiAurrera,
					btnAbestiAtzera);
	...
	public static void botoiakDesgaitu(JButton btnAbestiAurrera, JButton btnAbestiAtzera) {
	...
	/**
	 * Iragarkia hasieratzen duen metodoa. Metodo honek iragarkiaren soinua jaurtzen
	 * du.
	 * 
	 */
